...
@interface ViewController ()<UITextFieldDelegate,LYPickerChiceViewDelegate>
...
- (void)viewDidLoad {
    ...
    for (int i=0; i < arr.count; i++) {
        UITextField *textField = [[UITextField alloc] initWithFrame:CGRectMake(35, 50*i+50, 230, 30)];
        textField.tag = 100 + i;
